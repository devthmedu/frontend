...
const Pricing = ({ isDarkMode }) => {
    const plan = {
        name: "Plano Básico",
        desc: "Um plano básico ideal para iniciar seu projeto com recursos essenciais.",
        price: 32,
        isMostPop: true,
        features: [
            "Curabitur faucibus",
    ...
    const features = [
        {
            name: "Escalável",
            desc: "Cresça sua infraestrutura conforme a demanda do seu projeto.",
            icon: (
        ...
        {
            name: "Flexível",
            desc: "Adapte-se facilmente a novas necessidades e requisitos.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={isDarkMode ? "white" : "currentColor"} className="w-6 h-6">
        ...
        {
            name: "Suave",
            desc: "Experiência de usuário fluida e sem interrupções.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={isDarkMode ? "white" : "currentColor"} className="w-6 h-6">
        ...
        {
            name: "Seguro",
            desc: "Segurança robusta para proteger seus dados.",
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke={isDarkMode ? "white" : "currentColor"} className="w-6 h-6">
        ...
        <section className={`relative py-14 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-600'}`}>
            <div className="max-w-screen-xl mx-auto md:px-8">
                <header className='relative max-w-xl space-y-3 px-4 md:px-0'>
                    <h3 className="text-indigo-600 font-semibold">Preços</h3>
                    <h2 className='text-3xl font-semibold sm:text-4xl'>{plan.name}</h2>
                    <p>
                        Inicie seu projeto com um plano básico e cresça conforme suas necessidades.
                    </p>
                </header>
                        ...
                        <div className="p-4 py-8 border-b md:p-8">
                            <div className="flex justify-between">
                                ...
                                <div className='flex-none text-2xl font-semibold sm:text-3xl'>
                                    R$ {plan.price} <span className="text-xl font-normal">/mês</span>
                                </div>
                            </div>
