   ...
   const projects = {
        ...
        javascript: [
            ...
            },
            {
                ...
                img: '/portifolios/app-cripto.jpg',
                favicon: '/portifolios/favicon-projetos/Coin.webp',
                technologies: ['HTML', 'CSS', 'JavaScript', 'React'],
                date: 'Setembro de 2024',
                githubLink: 'https://github.com/devthmedu/App-Criptograficor',
                siteLink: 'https://app-criptografico.vercel.app/',
            },
            {
                ...
                favicon: '/portifolios/favicon-projetos/cafe.webp',
                technologies: ['HTML', 'CSS', 'JavaScript'],
                date: 'Setembro de 2024',
            ...
            },
            {
                ...
                favicon: '/portifolios/favicon-projetos/Key.webp',
            ...
            },
            {
                ...
                img: '/portifolios/formulario-de-perguntas.jpg',
                favicon: '/portifolios/favicon-projetos/Question.webp',
                technologies: ['HTML', 'CSS', 'JavaScript', 'React'],
                date: 'Agosto de 2024',
            ...
            },
            {
                ...
                img: '/portifolios/animais-fantasticos.jpg',
                favicon: '/portifolios/favicon-projetos/Tiger.webp',
                technologies: ['HTML', 'CSS', 'JavaScript'],
                date: 'Julho de 2024',
            ...
            },
            {
                ...
                img: '/portifolios/encurtador-de-link.jpg',
                favicon: '/portifolios/favicon-projetos/link.png',
                technologies: ['HTML', 'CSS', 'JavaScript', 'React'],
                date: 'Julho de 2024',
       ...
       mobile: [
            ...
            },
            {
                ...
                img: '/portifolios/App-mobile-Calculadora.jpg',
                favicon: '/portifolios/favicon-projetos/Abacus.webp',
                technologies: ['HTML', 'CSS', 'JavaScript'],
                date: 'Setembro de 2024',
        ...
        typescript: [
            {
                ...
                favicon: '/portifolios/favicon-projetos/Chart.webp',
            ...
            },
            {
                ...
                img: '#',
                favicon: '/portifolios/favicon-projetos/Robot.webp',
                technologies: [ 'CSS', 'JavaScript', 'Typescript'],
                date: 'Julho de 2024',
